...
import 'package:smart_clinic/chat.dart';
import 'package:smart_clinic/counseling.dart';
import 'package:smart_clinic/dateandtime.dart';
import 'package:smart_clinic/pharm.dart';
import 'package:smart_clinic/scr/widgets/icon_card.dart';
import 'package:smart_clinic/scr/widgets/images_cards.dart';
import 'package:smart_clinic/x_ray.dart';
import 'package:smart_clinic/lab.dart';
    ...
    return Scaffold(
      ...
      drawer: new Drawer(
        child: new ListView(
          ...
          InkWell(
            onTap: (){
              Navigator.of(context).push(MaterialPageRoute(builder: (_)=> DateAndTime()));
            },
              child: ListTile(
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  IconCard(iconData: Icons.local_pharmacy, text: 'Drug Store', onPressed: (){
                    Navigator.of(context).push(MaterialPageRoute(builder: (_)=> Pharms()));
                   },),
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  IconCard (iconData: Icons.local_hospital, text: 'Counselling', onPressed: (){
                    Navigator.of(context).push(MaterialPageRoute(builder: (_)=> Counsel()));
                   },),
                  IconCard(iconData: Icons.directions_subway, text: 'Check Disease'),
                  IconCard(iconData: Icons.directions, text: 'Map'),
                  IconCard(iconData: Icons.local_hospital, text: 'Chat', onPressed: (){
                    Navigator.of(context).push(MaterialPageRoute(builder: (_)=> App()));
                  },),
                ],
              ),
